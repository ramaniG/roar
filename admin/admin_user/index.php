...
<link rel="stylesheet" type="text/css" href="<?php echo _MEMBERCSS; ?>"
	media="screen" />
<style>
.table1 {
	margin: 0px;
				...
				<div class="right">
					<div class="wrapper">
						<div class="master-container member">
							...
							<div class="body">
								...
								<div class="right-col">
									<table>
										<tr>
											<td><h1 class="head1">ADMIN MANAGEMENT</h1></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
										</tr>
										<tr>
											<td>
												<div class="list">
													<?php
													$db = new Database();
													$sql = "SELECT id, username, IF(status=1, 'ACTIVE', 'NOT ACTIVE') as status,date_format(dateinserted, '%d %b %Y') as dateinserted FROM admin WHERE id != 1";
													$result = $db->query($sql);
													...
													<table width="700px" class="table1">
														...
														while ($row = mysql_fetch_row($result)) {
															...
															echo "<td>$row[2]</td>";
															echo "<td>{$row[3]}</td>";
															echo "<td><a class='chg-password' id='{$row[0]}'>change password</a></td>";
															echo "<td><a class='edit-status' id='{$row[0]}'>edit</a></td>";
															echo "</tr>";
															$i++;
														}
														?>
						...
						?>
										...
										<tr>
										<td><button id="adduser">Add Admin</button></td>
										</tr>
									</table>
								</div>
								<!-- end of right col -->
...
$('.chg-password').click(function() {
	$.fancybox.open({
	href : 'update_password.php?id='+$(this).attr('id'),
	type : 'iframe',
	padding : 5,
	width: 650,
	afterClose: function () {
...
$('.edit-status').click(function() {
	$.fancybox.open({
	href : 'update_user.php?id='+$(this).attr('id'),
	type : 'iframe',
	padding : 5,
	width: 650,
	afterClose: function () {
